...
Encore
    ...
    .setPublicPath('/build')
    .addEntry('vertical-timeline_reset', './assets/vertical-timeline-master/css/reset.css')
    .addEntry('vertical-timeline_style', './assets/vertical-timeline-master/css/style.css')
